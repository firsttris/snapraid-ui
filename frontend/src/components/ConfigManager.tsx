    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[85vh] flex flex-col">
        ...
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-gray-900">Manage Configurations</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {showAddForm ? (
            <div className="mb-6 p-5 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
              <h3 className="text-lg font-semibold mb-4 text-gray-900">Add New Configuration</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Media Server, Games, Backup"
          ...
          <div className="space-y-3">
            {config.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">No configurations yet</p>
                <p className="text-gray-400 text-sm mt-1">Add your first SnapRAID configuration to get started</p>
              </div>
            ) : (
              config.map((cfg) => (
                <div
